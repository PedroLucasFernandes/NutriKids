...
const historyModel = {
    async createHistory(title, story, created_by, updated_by, image_path) {
        ...
        const values = [title, story, created_by, updated_by, image_path];
    ...
    async updateHistory(id, title, story, updated_by, image_path) {
        ...
        const values = [title, story, updated_by, image_path, id];
