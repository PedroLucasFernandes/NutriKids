class CrosswordGameFoods {
    constructor() {
        ...
        this.clues = {
            '1': '1 - Sou uma ave que pode ser assada ou cozida e sou famosa por cantar ao amanhecer',
            '2': '2 - Grão nutritivo, base de muitos pratos brasileiros, especialmente acompanhado de arroz',
            '3': '3 - Sou redondo e posso ser cozido, frito ou mexido, essencial para um bom café da manhã',
            '4': '4 - Fonte de proteína, servida em bifes, moída ou em pedaços, popular em churrascos',
            '5': '5 - Um grão que é a base de muitas refeições, sempre presente no prato brasileiro, espacialmente acompanhando o feijão',
            '6': '5 - Vivo na água e sou uma escolha popular para uma refeição saudável, cheio de nutrientes importantes'
        };
        this.init();
    }
...
export default CrosswordGameFoods;
